...
rectangleCalculator.area().print("area").setUnit("mm").perimeter().print("perimeter").setUnit("dm").perimeter().print("perimeter");

const circleCalculator =  new Calculator("circle").exec({r: 5, unit: "m"});

circleCalculator.area().print("area").setUnit("cm").perimeter().print("perimeter");
